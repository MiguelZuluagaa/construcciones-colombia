            ...
            <div class="box-header" style="margin-bottom: 63px;">
              <div class="row">
                ...
                <div class="col-sm-2 col-sm-offset-10 ml-auto float-right" style="margin-right: 15px">
                  <a href="JavaScript:void(0)" class="btn btn-warning btn-block mb-4" data-toggle="modal" data-target="#modalNuevoProducto" >
    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <div class="modal-body modal-xl">
          <div class="content">
            <form method="POST" name="registrarSubObra" id="registrarSubObra"  onsubmit="return enviarRegistroSubObra(event);" action="procesarSubObra.php?accion=crear&cantidadTerm=1">
              <div class="row">
  ...
  <div id="modalModificarUsuario" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header header-modal-sany" style="background-color: #FFC107">
          <div class="row">
            <div class="form-group col-md-12 text-center" style="margin-bottom: -8px;background-color: #FFC107">
  ...
  function fnEliminarSubObra(idUsuario){
    ...
    .then((willDelete) => {
      if (willDelete) {
        ...
        window.location="<?= $base_url ?>pages/subObras/procesarSubObra.php?accion=eliminar&codigo="+idUsuario;
      } 
    });
  }
</script>
