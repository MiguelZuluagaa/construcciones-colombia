              ...
              <div class="box-header" style="margin-bottom: 63px;">
                <div class="row">
                  ...
                  <div class="col-sm-2 col-sm-offset-10 ml-auto float-right" style="margin-right: 15px">
                    <a href="JavaScript:void(0)" class="btn btn-warning btn-block mb-4" data-toggle="modal" data-target="#modalNuevaSubObra">
      ...
      swal({
        ...
        .then((willDelete) => {
          if (willDelete) {
            ...
            window.location = "<?= $base_url ?>pages/productos/procesarProducto.php?accion=eliminar&id=" + idUsuario;
          }
        });
    }
  </script>
